    ...
    public function render() {
      ...
      if ( isset( $this->field['options'] ) ) {
        ...
        if ( is_array( $options ) && ! empty( $options ) ) {
          ...
          echo ( ! empty( $this->field['empty_message'] ) ) ? esc_attr( $this->field['empty_message'] ) : esc_html__( 'No data available.', 'wpnice-accordion' );
        ...
        echo '<input type="hidden" name="'. esc_attr( $this->field_name() ) .'" value="'. wp_kses_post($this->value) .'" class="csf--input"'. wp_kses_post($this->field_attributes()) .'/>';
