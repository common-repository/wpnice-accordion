  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'wpnice-accordion' ),
        'right_placeholder'  => esc_html__( 'right', 'wpnice-accordion' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'wpnice-accordion' ),
        'left_placeholder'   => esc_html__( 'left', 'wpnice-accordion' ),
        'all_placeholder'    => esc_html__( 'all', 'wpnice-accordion' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'wpnice-accordion' ),
        'dashed'    => esc_html__( 'Dashed', 'wpnice-accordion' ),
        'dotted'    => esc_html__( 'Dotted', 'wpnice-accordion' ),
        'double'    => esc_html__( 'Double', 'wpnice-accordion' ),
        'inset'     => esc_html__( 'Inset', 'wpnice-accordion' ),
        'outset'    => esc_html__( 'Outset', 'wpnice-accordion' ),
        'groove'    => esc_html__( 'Groove', 'wpnice-accordion' ),
        'ridge'     => esc_html__( 'ridge', 'wpnice-accordion' ),
        'none'      => esc_html__( 'None', 'wpnice-accordion' )
      );
      ...
      if ( ! empty( $args['all'] ) ) {
        ...
        echo ( ! empty( $args['all_icon'] ) ) ? '<span class="csf--label csf--icon">'. wp_kese_post($args['all_icon']) .'</span>' : '';
        echo '<input type="number" name="'. esc_attr( $this->field_name( '[all]' ) ) .'" value="'. esc_attr( $value['all'] ) .'"'. esc_attr($placeholder) .' class="csf-input-number csf--is-unit" step="any" />';
