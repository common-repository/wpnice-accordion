...
if ( ! class_exists( 'CSF_Metabox' ) ) {
    class CSF_Metabox extends CSF_Abstract {
        ...
        public function add_meta_box_content( $post, $callback ) {
            ...
            foreach ( $this->sections as $section ) {
                ...
                if ( ! empty( $section[ 'fields' ] ) ) {
                    ...
                    echo '<div class="csf-no-option">'. esc_html__( 'No data available.', 'wpnice-accordion' ) .'</div>';
            ...
            if ( ! empty( $this->args[ 'show_restore' ] ) || ! empty( $this->args[ 'show_reset' ] ) ) {
                ...
                echo '<span class="button csf-button-reset">'. esc_html__( 'Reset', 'wpnice-accordion' ) .'</span>';
                echo '<span class="button csf-button-cancel">'. sprintf( '<small>( %s )</small> %s', esc_html__( 'update post', 'wpnice-accordion' ), esc_html__( 'Cancel', 'wpnice-accordion' ) ) .'</span>';
                echo '</label>';
                echo '</div>';
        ...
        public function save_meta_box( $post_id ) {
            ...
            $request = ( ! empty( $_POST[ $this->unique ] ) ) ? apply_filters('post_value',$_POST[ $this->unique ]) : array();
